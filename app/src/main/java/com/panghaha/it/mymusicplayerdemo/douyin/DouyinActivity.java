package com.panghaha.it.mymusicplayerdemo.douyin;
...
public class DouyinActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.douyin_main);
        initView();
        initListener();
    }
    ...
    private void playVideo(int position) {
        ...
        final FullWindowVideoView videoView = (FullWindowVideoView) itemView.findViewById(R.id.video_view);
        final ImageView imgPlay = (ImageView) itemView.findViewById(R.id.img_play);
        final ImageView imgThumb = (ImageView) itemView.findViewById(R.id.img_thumb);
